-- Editado em Dezembro de 2020, por Thalles Cotta Fontainha
-- IC 2020-1
--------------------------------------------------------------------------------------------------------------
...
---- Data Edição para IC: 28/12/2020

--------------------------------------------------------------------------------------------------------------
-- Database e tabase criados no servidor. Data Edição: 28/12/2020

CREATE TABLESPACE tablespace_enem_2016 LOCATION '/home/thallesf/Downloads/Microdados_enem_2016/DADOS';
ALTER DATABASE bd_enem_dados_2016 SET TABLESPACE tablespace_enem_2016; 

-- LOCATION foi o caminho que extrai o wget direto do servidor


--------------------------------------------------------------------------------------------------------------
-- Tabela criada no servidor. DATA CRIAÇÃO: 22/06/2016
-- Tabela revisada no servidor. DATA DA REVISÃO:26/06/2016
-- Data Edição: 28/12/2020
...
COMMENT ON column prova.id_prova is 'Número de identificação da prova do Enem (composição: Ano da prova + número da cor da prova: 2016+235=2016235)';
...
COMMENT ON column realiza.id_prova is 'Número de identificação da prova do Enem (composição: Ano da prova + número da cor da prova: 2016+235=2016235, chave estrangeira: realiza-prova)';
...
COMMENT ON column contem.id_prova is 'Número de identificação da prova do Enem (composição: Ano da prova + número da cor da prova: 2016+235=2016235, chave estrangeira: contem-prova)';
